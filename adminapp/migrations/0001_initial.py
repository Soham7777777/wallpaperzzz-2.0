    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(unique=True, upload_to=common.utils.FileUploadPathGenerator(pathlib.PurePosixPath('category_thumbnails'), 'thumbnail'), validators=[common.validators.MaxFileSizeValidator(1048576), django.core.validators.FileExtensionValidator(('png',))])),
            ],
        ),
        migrations.CreateModel(
            name='SettingsStore',
